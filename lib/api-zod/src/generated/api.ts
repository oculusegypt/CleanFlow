...
export const GetPackagesResponseItem = zod.object({
  ...
  "salePriceExpiresAt": zod.string().optional(),
...
export const GetCleaningOperationsResponse = zod.object({
...
export const GetCleaningOperationsRecordsQueryParams = zod.object({
  "kind": zod.coerce.string().optional(),
  "status": zod.coerce.string().optional(),
  "search": zod.coerce.string().optional()
})

export const GetCleaningOperationsRecordsResponseItem = zod.object({
  "id": zod.number(),
  "kind": zod.string(),
  "status": zod.string(),
  "reference": zod.string(),
...
export const GetCleaningOperationsRecordsResponse = zod.array(GetCleaningOperationsRecordsResponseItem)


export const CreateCleaningOperationsRecordBody = zod.object({
  "kind": zod.string(),
  "status": zod.string().optional(),
  "payload": zod.record(zod.string(), zod.unknown())
})

export const CreateCleaningOperationsRecordResponse = zod.object({
  "id": zod.number(),
  "kind": zod.string(),
  "status": zod.string(),
  "reference": zod.string(),
...
export const createCleaningContractWorkflowBodyOperationKeyMin = 8;
export const createCleaningContractWorkflowBodyOperationKeyMax = 160;



export const CreateCleaningContractWorkflowBody = zod.object({
  "operationKey": zod.string().min(createCleaningContractWorkflowBodyOperationKeyMin).max(createCleaningContractWorkflowBodyOperationKeyMax).optional(),
...
export const CreateCleaningContractWorkflowResponse = zod.object({
  "contract": zod.object({
  "id": zod.number(),
  "kind": zod.string(),
  "status": zod.string(),
...
export const UpdateCleaningOperationsRecordParams = zod.object({
  "id": zod.coerce.number()
})

export const UpdateCleaningOperationsRecordBody = zod.object({
  "status": zod.string().optional(),
  "payload": zod.record(zod.string(), zod.unknown()).optional()
})

export const UpdateCleaningOperationsRecordResponse = zod.object({
  "id": zod.number(),
  "kind": zod.string(),
  "status": zod.string(),
  "reference": zod.string(),
...
export const ArchiveCleaningOperationsRecordParams = zod.object({
  "id": zod.coerce.number()
})

export const ArchiveCleaningOperationsRecordResponse = zod.void()


export const GetCleaningOperationsAuditResponseItem = zod.object({
  "id": zod.number(),
...
export const GetCleaningOperationsAuditResponse = zod.array(GetCleaningOperationsAuditResponseItem)


export const GetCleaningPackageContractLedgersQueryParams = zod.object({
  "contractId": zod.coerce.number().optional(),
  "search": zod.coerce.string().optional()
})

export const GetCleaningPackageContractLedgersResponse = zod.object({
...
export const settleCleaningPackageContractHeaderIdempotencyKeyMin = 8;
export const settleCleaningPackageContractHeaderIdempotencyKeyMax = 160;



export const SettleCleaningPackageContractHeader = zod.object({
  "Idempotency-Key": zod.string().min(settleCleaningPackageContractHeaderIdempotencyKeyMin).max(settleCleaningPackageContractHeaderIdempotencyKeyMax)
})

export const settleCleaningPackageContractBodyAmountExclusiveMin = 0;

export const settleCleaningPackageContractBodyOperationKeyMin = 8;
export const settleCleaningPackageContractBodyOperationKeyMax = 160;

export const settleCleaningPackageContractBodyAllocationsItemAmountExclusiveMin = 0;




export const SettleCleaningPackageContractBody = zod.object({
  ...
  "amount": zod.number().gt(settleCleaningPackageContractBodyAmountExclusiveMin),
  "paymentMethod": zod.string(),
  "operationKey": zod.string().min(settleCleaningPackageContractBodyOperationKeyMin).max(settleCleaningPackageContractBodyOperationKeyMax),
  "depositId": zod.number().nullish(),
  "date": zod.string().optional(),
  "notes": zod.string().optional(),
  "allocations": zod.array(zod.object({
  "contractId": zod.number(),
  "amount": zod.number().gt(settleCleaningPackageContractBodyAllocationsItemAmountExclusiveMin),
  "invoiceId": zod.number().nullish()
})).min(1).optional()
})

export const SettleCleaningPackageContractResponse = zod.object({
  "payment": zod.object({
  "id": zod.number(),
  "kind": zod.string(),
  "status": zod.string(),
