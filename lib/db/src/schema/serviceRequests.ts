...
export const serviceRequestsTable = sqliteTable("service_requests", {
  ...
  // Legacy Hostinger snapshots used container_size. Keep it mapped in the
  // shared schema so inserts satisfy both old and current SQLite layouts.
  ...
  packageRecordId: integer("package_record_id"),
