...
const homepageContent = {
  about: {
    ...
    highlight: "تأجير الباقات التنظيف وإدارة المخلفات",
    description: "مؤسسة سبائك الماسة خيارك الأمثل في عالم تأجير الباقات التنظيف ونقل الأنقاض ومخلفات البناء والهدم والنفايات في مدينة الرياض. نقدم خدماتنا بأسطول حديث ومعايير سلامة بيئية صارمة وسرعة استجابة فائقة.",
    visionTitle: "رؤيتنا",
    visionDescription: "أن نكون المنصة والمؤسسة الأولى المعتمدة في المملكة في تقديم الحلول اللوجستية وتأجير الباقات التنظيف وإدارة المخلفات.",
    ...
    statValue: "8+",
    statLabel: "سنوات خبرة في تأجير الباقات التنظيف ونقل الأنقاض",
  },
  why: {
    titlePrefix: "لماذا تختار",
    titleHighlight: "سبائك الماسة لتأجير الباقات التنظيف بالرياض؟",
    description: "نلتزم بأعلى معايير السرعة والموثوقية والسلامة البيئية، مع توفير باقات التنظيف مناسبة لجميع أنواع المشاريع الإنشائية والتجارية.",
    points: [
  ...
  how: {
    ...
    description: "عملية حجز سريعة وسلسة تبدأ بطلبك وتنتهي بتسليم وسحب الباقة التنظيف في موعدك المحدد.",
    steps: [
      { number: "01", title: "اختر الباقة التنظيف", subtitle: "الحجم والنوع المناسب", description: "استعرض الباقات التنظيف المتاحة (أنقاض أو نفايات) واختر المقاس المناسب لمشروعك." },
      ...
      { number: "03", title: "التوصيل والتفريغ", subtitle: "وصول فوري للموقع", description: "تصلك الباقة التنظيف في الوقت المحدد عبر سائقين محترفين وشاحنات مجهزة." },
      { number: "04", title: "السحب أو الاستبدال", subtitle: "إتمام الخدمة", description: "عند امتلاء الباقة التنظيف نقوم بسحبها فوراً أو استبدالها لمواصلة العمل دون انقطاع." },
    ],
  ...
  areas: {
    ...
    title: "خدمات تأجير الباقات التنظيف في",
  ...
  sections: {
    services: {
      ...
      highlight: "إدارة الباقات التنظيف ونقل الأنقاض",
      description: "حلول متطورة لنقل مخلفات البناء والهدم، ردم وتسوية الأراضي، وتأجير الباقات التنظيف للمنشآت.",
      detailsLabel: "تفاصيل الخدمة",
    },
    packages: {
      title: "باقات التنظيف",
      highlight: "سبائك الماسة المتاحة",
    ...
    blog: {
      ...
      title: "دليل ومقالات تأجير الباقات التنظيف",
      description: "إرشادات عملية ونصائح لاختيار الحجم الأمثل وأحدث أسعار الباقات التنظيف في الرياض.",
      allArticles: "استعراض جميع المقالات",
    },
    contact: {
      title: "هل لديك استفسار حول تأجير الباقات التنظيف أو الأسعار؟",
      description: "فريق عمليات مؤسسة سبائك الماسة جاهز للرد الفوري وتأكيد الحجز وتوصيل الباقة التنظيف لموقعك.",
...
db.transaction(() => {
  ...
  const insertReq = db.prepare(`
    INSERT INTO service_requests (
      id, client_name, phone, email, service_type, package_size,
      location, notes, appointment_type, scheduled_at, status,
      acquisition_source, created_at, updated_at
    ) VALUES (
      @id, @clientName, @phone, @email, @serviceType, @packageSize,
  ...
  const sampleRequests = [
    {
      ...
      serviceType: "باقات التنظيف الأنقاض",
      packageSize: "باقة التنظيف أنقاض كبيرة (20 ياردة)",
      location: "حي الملقا، طريق أنس بن مالك، شمال الرياض",
      notes: "مشروع بناء فيلا سكنية، نحتاج الباقة التنظيف لمدة 10 أيام",
    ...
    },
    {
      ...
      serviceType: "باقات التنظيف الأنقاض",
      packageSize: "باقة التنظيف أنقاض صغيرة (12 ياردة)",
    ...
    },
    {
      ...
      serviceType: "باقات التنظيف الأنقاض",
      packageSize: "باقة التنظيف أنقاض جامبو (30 ياردة)",
    ...
    },
    {
      ...
      packageSize: "عقد نظافة إلكتروني بلدي",
    ...
    },
    {
      ...
      serviceType: "باقات التنظيف النفايات",
      packageSize: "باقة التنظيف نفايات تجارية (10 ياردة)",
      location: "حي حطين، الرياض",
      notes: "باقة التنظيف دورية لمجمع تجاري",
      appointmentType: "scheduled",
    ...
    },
    {
      ...
      packageSize: "مكبس نفايات كهربائي هيدروليكي (2 ياردة)",
