...
export const PUBLIC_PRICING_NOTICE =
  "الأسعار الموضحة أدناه تشمل إيجار الباقة التنظيف لمدة تصل إلى 10 أيام للرد الواحد، مع النقل والتفريغ في المرادم الرسمية التابعة لأمانة منطقة الرياض دون أي رسوم خفية."

export const PUBLIC_PRICING_PACKAGES: PublicPricingPackage[] = [
  {
    name: "باقة التنظيف أنقاض صغيرة (12 ياردة)",
    size: "12 ياردة",
  ...
  {
    name: "باقة التنظيف أنقاض متوسطة (15 ياردة)",
    size: "15 ياردة",
  ...
  {
    name: "باقة التنظيف أنقاض كبيرة (20 ياردة)",
    size: "20 ياردة",
  ...
  {
    name: "باقة التنظيف أنقاض جامبو (30 ياردة)",
    size: "30 ياردة",
  ...
  {
    name: "باقة التنظيف نفايات تجارية (6 و 10 ياردة)",
    size: "6 - 10 ياردة",
    capacity: "سعة 6 - 8 م³",
    priceLabel: "عقد سنوي / حسب الموقع",
    priceNote: "عقد نظافة موثق ومعتمد لتجديد رخص الأنشطة التجارية",
    best: ["مخصصة للمطاعم والمقاهي والمحلات", "تفريغ دوري أسبوعي أو شهري منتظم", "ربط فوري ومباشر مع منصة بلدي", "باقات التنظيف محكمة الغلق ومطابقة للنظافة"],
