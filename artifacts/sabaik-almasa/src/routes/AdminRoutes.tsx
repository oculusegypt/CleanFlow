...
const AdminCleaningOperations = lazy(() => import("@/pages/admin/CleaningOperations"))
const CleaningPackageRecordProfile = lazy(() => import("@/pages/admin/CleaningServiceRecordProfile").then(module => ({ default: module.CleaningPackageRecordProfile })))
const ContractPrintPage = lazy(() => import("@/pages/admin/CleaningServiceRecordProfile").then(module => ({ default: module.ContractPrintPage })))
    ...
    <AdminLayout>
      <Suspense fallback={<div className="min-h-[50vh] flex items-center justify-center"><div className="w-8 h-8 border-3 border-primary/20 border-t-primary rounded-full animate-spin" /></div>}>
        <Switch>
          ...
          <Route path="/admin/packages" component={AdminPackages} />
          <Route path="/admin/cleaning-operations" component={AdminCleaningOperations} />
          <Route path="/admin/cleaning-operations/profile/customer/:id" component={() => <CleaningPackageRecordProfile mode="customer" />} />
          <Route path="/admin/cleaning-operations/profile/employee/:id" component={() => <CleaningPackageRecordProfile mode="employee" />} />
          <Route path="/admin/cleaning-operations/profile/package/:id" component={() => <CleaningPackageRecordProfile mode="package" />} />
          <Route path="/admin/cleaning-operations/contract/:id/print" component={ContractPrintPage} />
          <Route path="/admin/cleaning-operations/invoice/:id/details" component={InvoicePrintPage} />
          <Route path="/admin/cleaning-operations/invoice/:id/print" component={InvoicePrintPage} />
          <Route path="/admin/ads"><Redirect to="/admin/offers" /></Route>
          <Route path="/admin/offers" component={AdminAds} />
