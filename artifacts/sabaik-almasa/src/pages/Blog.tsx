...
export default function Blog() {
  useDocumentSEO({
    title: "مدونة التنظيف بالرياض | نصائح للعناية بالمنزل",
    description: "اقرأ نصائح عملية عن تنظيف المنازل والفلل والمجالس والمكيفات وجلي الرخام واختيار الخدمة المناسبة في الرياض.",
    keywords: "نصائح تنظيف المنازل بالرياض, تنظيف الفلل, تنظيف المجالس, جلي الرخام, تنظيف المكيفات",
