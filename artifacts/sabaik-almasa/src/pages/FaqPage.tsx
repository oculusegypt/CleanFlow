...
const FAQS: FAQItem[] = [
  {
    ...
    q: "ما هي مقاسات وأسعار باقات التنظيف الأنقاض في الرياض؟",
    a: "نوفر 4 مقاسات رئيسية لباقات التنظيف الأنقاض: باقة التنظيف صغيرة 12 ياردة (400 ريال)، باقة التنظيف متوسطة 15 ياردة (450 ريال)، باقة التنظيف كبيرة 20 ياردة (500 ريال)، وباقة التنظيف جامبو 30 ياردة (700 ريال). السعر يشمل التوصيل، مدة بقاء 10 أيام، والنقل والتفريغ في المرادم الرسمية."
  },
  {
    category: "عام والتسعير",
    q: "كم مدة بقاء الباقة التنظيف في الموقع للرد الواحد؟",
    a: "مدة بقاء الباقة التنظيف المعتمدة هي 10 أيام للرد الواحد. يمكن للعميل طلب سحب الباقة التنظيف وتفريغها مبكراً بمجرد امتلائها أو تمديد المدة بالتنسيق مع قسم العمليات."
  },
  {
    category: "عام والتسعير",
  ...
  {
    category: "باقات التنظيف الأنقاض ومخلفات البناء",
    q: "ما هي المواد المسموح بوضعها داخل باقة التنظيف الأنقاض؟",
  ...
  },
  {
    ...
    a: "مشاريع الترميم وتعديل الشقق والفلل الصغيرة تناسبها باقات التنظيف 12 أو 15 ياردة. أما مشاريع بناء الفلل، الهدم والإنشاءات الكبرى فينصح باختيار باقات التنظيف 20 أو 30 ياردة لتقليل عدد الردود والتكلفة."
  },
  {
  ...
  {
    category: "باقات التنظيف النفايات والمكابس",
  ...
  },
  {
    ...
    q: "كم يستغرق توصيل الباقة التنظيف لموقعي في الرياض؟",
    a: "نوفر خدمة التوصيل الفوري خلال ساعتين من تأكيد الطلب، مع إمكانية حجز مواعيد مسبقة تناسب خطة العمل في موقعك."
  },
  {
    category: "التوصيل والسلامة",
    q: "كيف تضمنون سلامة الأرصفة والشارع أثناء تنزيل وسحب الباقة التنظيف؟",
    a: "شاحناتنا مجهزة بأنظمة هيدروليكية دقيقة، ويقوم سائقونا بوضع الباقة التنظيف بعناية فائقة في المكان المخصص دون الإضرار بالبلاط أو الأرصفة أو إعاقة حركة المرور."
  }
]
...
export default function FaqPage() {
  ...
  const categories = ["الكل", "عام والتسعير", "باقات التنظيف الأنقاض ومخلفات البناء", "عقود النظافة ورخص بلدي", "باقات التنظيف النفايات والمكابس", "التوصيل والسلامة"]
  ...
  useDocumentSEO({
    title: companyName ? `الأسئلة الشائعة حول تأجير الباقات التنظيف بالرياض | ${companyName}` : "الأسئلة الشائعة حول تأجير الباقات التنظيف وعقود بلدي بالرياض",
    description: "إجابات شاملة ومفصلة لكافة الأسئلة الشائعة حول مقاسات وأسعار تأجير باقات التنظيف الأنقاض والنفايات وعقود النظافة الإلكترونية المعتمدة بالرياض.",
        ...
        <div className="mt-16 bg-gradient-to-br from-primary to-primary/95 text-white rounded-3xl p-8 md:p-10 shadow-xl flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="space-y-2 text-center md:text-right">
            ...
            <p className="text-white/80 text-sm md:text-base">
              فريق عمليات {resolvedCompany} جاهز للتنسيق وتحديد المقاس الأنسب وتوصيل الباقة التنظيف لموقعك فوراً.
            </p>
          </div>
          <div className="flex flex-wrap gap-3 shrink-0">
            ...
            {whatsappNumber && (
              <a
                href={`https://wa.me/966${whatsappNumber.replace(/^0/, "")}?text=${encodeURIComponent("مرحباً، لدي استفسار بخصوص تأجير الباقات التنظيف بالرياض")}`}
                target="_blank"
