...
export default function NeighborhoodPage() {
  ...
  const wa = `https://wa.me/966${cleanPhone.replace(/^0/, "")}?text=${encodeURIComponent(`السلام عليكم، أرغب في طلب تأجير باقة التنظيف في ${area.name} بالرياض`)}`
          ...
          <div className="container mx-auto px-4 md:px-6">
            ...
            <div className="max-w-4xl space-y-4">
              ...
              <div className="flex gap-4 flex-wrap pt-4">
                ...
                >
                  <Box size={18} /> اطلب الباقة التنظيف الآن
                </button>
                <a
                  href={wa}
                  target="_blank"
