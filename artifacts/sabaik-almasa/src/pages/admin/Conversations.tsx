...
import { useGetConversations, useGetMessages, useSendMessage, useUpdateConversation, useGetPackages } from "@workspace/api-client-react"
...
export default function AdminConversations() {
  ...
  const handleSendPackageForm = () => {
    ...
    const serviceType = resolveServiceTypeFromCleaningPackage(selectedPackage)
    sendMsg({
      id: selectedId,
      data: {
