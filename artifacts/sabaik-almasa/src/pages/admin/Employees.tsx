...
const ALL_SECTIONS: { key: string; label: string; group: string }[] = [
  ...
  { key: "packages",     label: "باقات التنظيف الأنقاض والنفايات", group: "محتوى" },
  ...
  { key: "container_system", label: "نظام الباقات التنظيف الكامل", group: "التشغيل" },
  { key: "container_system_customer", label: "الباقات التنظيف: العملاء", group: "سيستم الباقات التنظيف" },
  { key: "container_system_container", label: "الباقات التنظيف: الأصول", group: "سيستم الباقات التنظيف" },
  { key: "container_system_container_asset", label: "الباقات التنظيف: أصول الباقات التنظيف", group: "سيستم الباقات التنظيف" },
  { key: "container_system_container_type", label: "الباقات التنظيف: التصنيفات والأحجام", group: "سيستم الباقات التنظيف" },
  { key: "container_system_category", label: "الباقات التنظيف: الأصناف", group: "سيستم الباقات التنظيف" },
  { key: "container_system_category_size", label: "الباقات التنظيف: أحجام الأصناف", group: "سيستم الباقات التنظيف" },
  { key: "container_system_contract", label: "الباقات التنظيف: العقود والإيجارات", group: "سيستم الباقات التنظيف" },
  { key: "container_system_contract_line", label: "الباقات التنظيف: بنود العقود", group: "سيستم الباقات التنظيف" },
  { key: "container_system_container_movement", label: "الباقات التنظيف: التبديل والتفريغ", group: "سيستم الباقات التنظيف" },
  { key: "container_system_ledger_entry", label: "الباقات التنظيف: قيود وكشوف الحساب", group: "سيستم الباقات التنظيف" },
  { key: "container_system_receipt", label: "الباقات التنظيف: سندات القبض والصرف", group: "سيستم الباقات التنظيف" },
  { key: "container_system_payment", label: "الباقات التنظيف: سداد العملاء", group: "سيستم الباقات التنظيف" },
  { key: "container_system_deposit", label: "الباقات التنظيف: الإيداعات", group: "سيستم الباقات التنظيف" },
  { key: "container_system_bank_deposit", label: "الباقات التنظيف: الإيداعات البنكية", group: "سيستم الباقات التنظيف" },
  { key: "container_system_treasury", label: "الباقات التنظيف: الخزائن", group: "سيستم الباقات التنظيف" },
  { key: "container_system_transfer", label: "الباقات التنظيف: التحويلات", group: "سيستم الباقات التنظيف" },
  { key: "container_system_expense", label: "الباقات التنظيف: الإيرادات والمصروفات", group: "سيستم الباقات التنظيف" },
  { key: "container_system_reports", label: "الباقات التنظيف: التقارير", group: "سيستم الباقات التنظيف" },
  { key: "container_system_salary", label: "الباقات التنظيف: قسم الرواتب", group: "سيستم الباقات التنظيف" },
  { key: "container_system_salary_advance", label: "الباقات التنظيف: السلف", group: "سيستم الباقات التنظيف" },
  { key: "container_system_salary_payment", label: "الباقات التنظيف: صرف الرواتب", group: "سيستم الباقات التنظيف" },
  { key: "container_system_vehicle", label: "الباقات التنظيف: الشاحنات", group: "سيستم الباقات التنظيف" },
  { key: "container_system_driver", label: "الباقات التنظيف: السائقون", group: "سيستم الباقات التنظيف" },
  { key: "container_system_maintenance", label: "الباقات التنظيف: الصيانة", group: "سيستم الباقات التنظيف" },
  { key: "container_system_permit", label: "الباقات التنظيف: التصاريح", group: "سيستم الباقات التنظيف" },
  { key: "container_system_oil_change", label: "الباقات التنظيف: غيار الزيت والعدادات", group: "سيستم الباقات التنظيف" },
  { key: "container_system_fuel_expense", label: "الباقات التنظيف: مصروفات الوقود", group: "سيستم الباقات التنظيف" },
  { key: "container_system_daily_expense", label: "الباقات التنظيف: المصروفات اليومية", group: "سيستم الباقات التنظيف" },
  { key: "container_system_warehouse", label: "الباقات التنظيف: المستودعات والمخازن", group: "سيستم الباقات التنظيف" },
  { key: "container_system_appointment", label: "الباقات التنظيف: المواعيد والحجوزات", group: "سيستم الباقات التنظيف" },
  { key: "container_system_branch", label: "الباقات التنظيف: الفروع", group: "سيستم الباقات التنظيف" },
  { key: "container_system_employee", label: "الباقات التنظيف: الموظفون والسائقون", group: "سيستم الباقات التنظيف" },
  { key: "container_system_invoice", label: "الباقات التنظيف: الفواتير", group: "سيستم الباقات التنظيف" },
  { key: "container_system_invoice_return", label: "الباقات التنظيف: مرتجعات الفواتير", group: "سيستم الباقات التنظيف" },
  { key: "container_system_tax", label: "الباقات التنظيف: الضرائب", group: "سيستم الباقات التنظيف" },
  { key: "container_system_commission", label: "الباقات التنظيف: العمولات", group: "سيستم الباقات التنظيف" },
  { key: "container_system_alert", label: "الباقات التنظيف: التنبيهات", group: "سيستم الباقات التنظيف" },
  { key: "container_system_settings", label: "الباقات التنظيف: الإعدادات", group: "سيستم الباقات التنظيف" },
  { key: "container_system_audit", label: "الباقات التنظيف: سجل التدقيق", group: "سيستم الباقات التنظيف" },
]
