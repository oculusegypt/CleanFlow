...
function bodyDescription(service: Service): string {
  ...
  if (!raw) return "خدمات تأجير الباقات التنظيف ونقل الأنقاض بالرياض — تواصل معنا لمزيد من التفاصيل."
...
const DEFAULT_CONTAINER_INTEL = {
  equipment: ["شاحنات وايت مان هيدروليكية حديثة", "باقات التنظيف حديدية مقواة مقاومة للصدمات", "أغطية وشباك حماية مطابقة للاشتراطات البيئية", "رافعات سحب وإنزال متطورة لتفادي الإضرار بالأرصفة"],
  processSteps: [
    { title: "استلام الطلب وتحديد المقاس", desc: "تحديد حجم الباقة التنظيف المناسب (12-30 ياردة) ونوع المخلفات بدقة." },
    { title: "التوصيل والتنزيل الميداني", desc: "وصول الشاحنة وتنزيل الباقة التنظيف في الموقع المعتمد بطريقة آمنة وسلسة." },
    { title: "فترة الاستخدام والتعبئة", desc: "مدة بقاء الباقة التنظيف حتى 10 أيام للرد مع إمكانية التمديد والتنسيق المرن." },
    { title: "السحب والتفريغ في المردم", desc: "تغطية الباقة التنظيف بشبك الحماية ونقلها إلى المرادم الرسمية التابعة لأمانة الرياض." }
  ],
  pricingFactors: [
    { factor: "حجم ومقاس الباقة التنظيف", detail: "تختلف التكلفة من الباقة التنظيف الصغيرة 12 ياردة (400 ريال) إلى الجامبو 30 ياردة (700 ريال)." },
  ...
  faqs: [
    { q: "كم مدة بقاء الباقة التنظيف في الموقع؟", a: "مدة بقاء الباقة التنظيف القياسية هي 10 أيام للرد الواحد، ويمكن طلب السحب المبكر أو التمديد عند الحاجة." },
    { q: "هل يشمل السعر النقل والتفريغ في المردم الرسمي؟", a: "نعم، السعر شامل توصيل الباقة التنظيف، سحبها بعد الامتلاء، والتفريغ النظامي في المرادم المعتمدة من أمانة الرياض." },
    { q: "كيف يتم طلب تفريغ الباقة التنظيف أو سحبها؟", a: "يكفي إرسال رسالة واتساب أو الاتصال برقم العمليات لتوجيه السائق وسحب الباقة التنظيف خلال وقت قياسي." }
  ]
}
...
const SERVICE_INTEL: Record<string, {
  ...
  "taajir-hawiyat-anqad-alryad": {
    equipment: ["باقات التنظيف صلب مقوى 12 و 15 و 20 و 30 ياردة", "شاحنات سحب هيدروليكية ذات قدرة رفع عالية", "أغطية حماية مطابقة للاشتراطات البيئية والأمان"],
    processSteps: [
      { title: "تحديد المقاس المناسب", desc: "مساعدة العميل في اختيار حجم الباقة التنظيف الملائم لكمية أنقاض الهدم والترميم." },
      { title: "التوصيل والوضع الآمن", desc: "إنزال الباقة التنظيف أمام الموقع أو في الارتداد المسموح دون إعاقة حركة السير." },
      { title: "التعبئة والتحميل", desc: "تعبئة الأنقاض والخرسانة والبلوك حتى الحد المسموح للأمان." },
      { title: "السحب والنقل للمردم", desc: "سحب الباقة التنظيف والتفريغ في المقالب والمرادم الرسمية المعتمدة." }
    ],
    pricingFactors: [
      { factor: "مقاس الباقة التنظيف", detail: "12 ياردة (400 ريال) - 15 ياردة (450 ريال) - 20 ياردة (500 ريال) - 30 ياردة (700 ريال)." },
      { factor: "عدد الردود", detail: "خصومات خاصة للمشاريع التي تتطلب ردوداً متعددة وعقوداً دورية." }
    ],
    faqs: [
      { q: "ما هي المواد المسموح بوضعها في باقات التنظيف الأنقاض؟", a: "يسمح بوضع مخلفات الهدم، الخرسانة، البلوك، الرمل، الجبس، البلاط، والحديد." },
      { q: "كم سرعة التوصيل بعد تأكيد الطلب؟", a: "يتم توصيل الباقة التنظيف لموقعك في الرياض خلال ساعتين كحد أقصى للطلبات الفورية." }
    ]
  },
  "aqd-nazafa-baladi-alryad": {
    equipment: ["منصة إلكترونية معتمدة للربط مع بلدي", "باقات التنظيف نفايات ومكابس مطابقة للمواصفات", "أسطول جمع دوري مجدول"],
    processSteps: [
      ...
      { title: "توريد الباقة التنظيف المخصصة", desc: "توفير باقة التنظيف النفايات المناسبة وفق اشتراطات الأمانة للنشاط." },
    ...
    pricingFactors: [
      ...
      { factor: "سعة الباقة التنظيف المطلوبة", detail: "باقات التنظيف 6 أو 10 ياردة أو مكابس كهربائية 2 ياردة." }
    ],
    faqs: [
...
export default function ServiceDetail() {
  ...
  const bodyText = service ? bodyDescription(service) : (companyName ? `تعرف على خدمات ${companyName} لتأجير الباقات التنظيف ونقل الأنقاض في الرياض.` : "تعرف على خدمات تأجير الباقات التنظيف ونقل الأنقاض في الرياض.")
  const metaText = service ? metaDescription(service) : (companyName ? `خدمات تأجير باقات التنظيف ونقل مخلفات احترافية في الرياض من ${companyName} بأسطول حديث 24/7.` : "خدمات تأجير باقات التنظيف ونقل مخلفات احترافية في الرياض بأسطول حديث 24/7.")
  const title = service ? (companyName ? `${service.seoTitle?.trim() || service.title} | ${companyName}` : (service.seoTitle?.trim() || service.title)) : (companyName ? `خدمات الباقات التنظيف بالرياض | ${companyName}` : "خدمات تأجير الباقات التنظيف بالرياض")
  ...
  useDocumentSEO({
    ...
    keywords: service?.seoKeywords || `${service?.title || "باقات التنظيف"}, تأجير باقات التنظيف بالرياض, باقات التنظيف أنقاض الرياض, باقات التنظيف نفايات الرياض`,
    canonical,
    ogType: "website",
